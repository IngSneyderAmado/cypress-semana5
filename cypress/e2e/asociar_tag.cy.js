describe('Asociar tag', () => {
    it('Se asocia un tag desde el inicio de sesión hasta la finalización de la creación', () => {
      ...
      cy.wait(2000)
      cy.get('#tag-name').type('Prueba asociar tag')
      cy.wait(2000)
      ...
      cy.get(".gh-nav-list-new > a[href='#/posts/']").click();
        ...
        cy.wait(2000)
        cy.get('.gh-editor-title').type('Prueba asociar tag');
        ...
        cy.wait(5000);
        cy.contains('h3', 'Prueba asociar tag').click()
        cy.wait(5000)
        cy.get('button[class="post-settings"]').click()
        cy.wait(5000)
        cy.get('#tag-input').click()
        cy.wait(5000)
        cy.contains('li', 'Prueba asociar tag').click()
        cy.wait(5000)
